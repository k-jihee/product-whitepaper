...
def page_chatbot():
    ...
    # 0) 이 페이지에서는 헤더/메인 컨테이너 스크롤을 정리하고,
    #    ✅ 사이드바 '펼치기 화살표(→)'가 iframe 위로 보이도록 z-index를 올립니다.
    st.markdown(
        """
        <style>
        /* 상단 기본 헤더 숨기기 */
        ...
        /* 전체 앱 컨테이너/메인 영역 스크롤 숨기기 (챗봇 화면 풀스크린 느낌) */
        html, body,
        [data-testid="stAppViewContainer"],
        [data-testid="stMain"],
        ...
        /* ✅ 사이드바 토글 버튼(→/←)이 iframe에 가리지 않도록 최상단으로 */
